...
def compare_noise_estimation(image_path, output_path_visual, output_path_mse, output_path_psnr):
    ...
    image = load_image(image_path)
    true_sigma = 17
    noisy = add_gaussian_noise(image * 255, sigma=true_sigma).astype(np.float32) / 255.0
