...
\begin{frame}{Spatial Sampling (Semi-Local NLM)}
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.5\textwidth}
      \centering
      \includegraphics[width=1.2\linewidth,height=0.6\textheight,keepaspectratio]{mc_matches_1.pdf}
      \vspace{-0.1cm}
    \column{0.5\textwidth}
      \centering
      \includegraphics[width=1.2\linewidth,height=0.6\textheight,keepaspectratio]{mc_matches_2.pdf}
      \vspace{-0.1cm}
  \end{columns}
\end{frame}
...
\begin{frame}{Hashed NLM}
  ...
  \vspace{0cm}
  \centering
  \includegraphics[width=0.6\linewidth]{hashednlm_zoomed4.pdf}
\end{frame}
